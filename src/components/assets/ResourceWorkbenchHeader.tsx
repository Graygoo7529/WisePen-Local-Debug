...
export function ResourceWorkbenchHeader({
  ...
  return (
    <div className="shrink-0 border-b border-line bg-bg-elev">
      ...
      <div className="flex min-h-10 flex-wrap items-center gap-x-3 gap-y-1 border-t border-line px-4 py-1.5">
        ...
        />
        <div className="flex min-w-0 flex-1 flex-wrap items-center py-0.5">{status}</div>
      </div>
    </div>
  );
}
